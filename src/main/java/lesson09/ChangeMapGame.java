 ...
 */
public class ChangeMapGame extends BasicGame {
    ...
    public static void main(String[] args) throws SlickException {
        new AppGameContainer(new ChangeMapGame(), 800, 600, false).start();
    }

    public ChangeMapGame() {
        super("Lesson 9 :: ChangeMapGame");
    }
